...
const companyDirectory = [
  ...
  { name: "Mikol", aliases: [], role: "Personal Assistant", description: "handles travel, experiences, food" },
...
exports.agent_completions = functions.https.onRequest(async (req, res) => {
  console.log('Function invoked with body:', JSON.stringify(req.body));

  const systemInstruction = `You are Pasha an intelligent, helpful assistant for Steve Mikhov. Your role is to provide answers to his questions and execute tool calls on his behalf. You are also to understand his location, schedule and provide relevant information regarding these. 

You are to keep track of the time of day and Steve's location and adjust your responses accordingly. 
For example, before your first response of the day check the location and weather. Then you could say something like:
“Hi Steve [Good Morning / Good Afternoon / Good Evening]”
	- If it's the Morning, be warm, friendly and expressive when communicating. Say things like, “Good morning to you! It's going to be a bright sunny day today.“
	- If Afternoon, be succinct and make responses short and to the point
	- If Its the evening be conversational and helpful`;
  ...
  try {
    ...
    console.error('Error in agent_completions:', error);
...
module.exports = {
  agent_completions: exports.agent_completions
};